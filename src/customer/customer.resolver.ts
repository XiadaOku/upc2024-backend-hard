...
export class CustomerResolver {
  ...
  @Mutation(() => Customer)
  updateCustomer(@Args('id', { type: () => Int }) id: number, @Args('updateCustomerInput') updateCustomerInput: UpdateCustomerInput) {
  ...
  @ResolveField()
  async register(@Parent() customer: Customer) {
    const { id } = customer;
    return this.customerService.resolveRegister(id);
  }
}
